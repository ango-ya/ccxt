declare module '@ango-ya/ccxt' {
    ...
    export class InvalidUsdOrder extends InvalidOrder {}
    export class InvalidRangeOrder extends InvalidOrder {}
    ...
    export class Exchange {
        ...
        fetchMarkets ({}, currencyPairs?): Promise<Market[]>;
        ...
        callLoadMarkets(coinListData: string, marketData?: string): Promise<void>;
    }

...
import { ExchangeError, OrderNotFound } from './base/errors.js';
...
export default class btse extends Exchange {
    ...
    async fetchMarkets (symbol = undefined, params = {}): Promise<Market[]> {
    ...
    parseOrderStatusCode (statusCode: number): string {
        const statuses = {
            '2': 'open',         // Order is inserted successfully
            '4': 'closed',       // Order is fully transacted
            '5': 'open',         // Order is partially transacted
            '6': 'canceled',     // Order is cancelled successfully
            '8': 'rejected',     // Insufficient balance in account
            '9': 'open',         // Trigger Order is inserted successfully
            '10': 'open',        // Trigger Order is activated successfully
            '15': 'rejected',    // Order Rejected
            '16': 'rejected',    // Order is not found

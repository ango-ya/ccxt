...
export default class Exchange {
    ...
    async loadMarkets (coinListData = undefined, marketData = undefined, reload = false, params = {}): Promise<Dictionary<Market>> {

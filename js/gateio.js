...
const { OrderImmediatelyFillable, AccountNotEnabled, ExchangeError, ExchangeNotAvailable, ArgumentsRequired, BadRequest, AccountSuspended, PermissionDenied, InsufficientFunds, InvalidOrder, OrderNotFound, AuthenticationError, BadSymbol, RateLimitExceeded } = require ('./base/errors');
